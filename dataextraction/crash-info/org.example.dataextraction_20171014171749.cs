...
PID: 14283
Date: 2017-10-14 17:17:49+0200
Executable File Path: /opt/usr/apps/org.example.dataextraction/bin/dataextraction
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 14283, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000037cb
r2   = 0x00000006, r3   = 0x000037cb
r4   = 0x00000006, r5   = 0x000f5528
r6   = 0x4040cbec, r7   = 0x0000010c
r8   = 0x42f931a0, r9   = 0x00000002
r10  = 0x0000007f, fp   = 0xbef1bc28
ip   = 0x42f93660, sp   = 0xbef1b4f0
...
Threads: 7
PID = 14283 TID = 14283
14283 14284 14285 14295 14296 14297 14298 
...
4003a000 4003d000 rw-p [stack:14285]
...
4368a000 43e89000 rw-p [stack:14284]
441d0000 441d1000 r-xp /usr/lib/evas/modules/loaders/eet/linux-gnueabi-armv7l-1.7.99/module.so
441da000 449d9000 rw-p [stack:14295]
449da000 451d9000 rw-p [stack:14296]
451da000 459d9000 rw-p [stack:14297]
45b01000 46300000 rw-p [stack:14298]
beefc000 bef1d000 rw-p [stack]
End of Maps Information

Callstack Information (PID:14283)
Call Stack Count: 1
...
sg port [true][0m
10-14 17:17:57.485+0200 W/AUL_AMD (  532): amd_request.c: __request_handler(645) > __request_handler: 14
10-14 17:17:57.495+0200 W/AUL_AMD (  532): amd_request.c: __send_result_to_client(83) > __send_result_to_client, pid: 1063
10-14 17:17:57.530+0200 I/SCONTEXT-LIB(14317): comm.c: cx_connect_dbus(148) > Dbus connected: ':1.3103'
10-14 17:17:57.530+0200 I/SCONTEXT-LIB(14317): scontext.c: context_add_changed_cb(211) > [SUCCESS] Set Changed CB: 45 (req_id=1)
10-14 17:17:57.530+0200 I/SCONTEXT-LIB(14317): scontext.c: context_get_context(108) > [SUCCESS] Get Context: 45 (req_id=2)
10-14 17:17:57.530+0200 W/MUSIC_CONTROL_SERVICE( 1814): music-control-message.c: music_control_message_send_media_changed_ind(231) > [36m[TID:1814]   [MUSIC_PLAYER_EVENT][0m
10-14 17:17:57.545+0200 E/CAPI_APPFW_APPLICATION_PREFERENCE( 1814): preference.c: _preference_check_retry_err(507) > key(music-control-service_native/playing_diration), check retry err: -21/(2/No such file or directory).
10-14 17:17:57.545+0200 E/CAPI_APPFW_APPLICATION_PREFERENCE( 1814): preference.c: _preference_get_key(1101) > _preference_get_key(music-control-service_native/playing_diration) step(-17825744) failed(2 / No such file or directory)
10-14 17:17:57.545+0200 E/CAPI_APPFW_APPLICATION_PREFERENCE( 1814): preference.c: preference_get_int(1132) > preference_get_int(1814) : key(music-control-service_native/playing_diration) error
10-14 17:17:57.545+0200 W/MUSIC_CONTROL_SERVICE( 1814): music-control-info.c: music_control_info_get_player_position(603) > [31m[TID:1814]   preference_get_int() .. [0xfef00030][0m
10-14 17:17:57.550+0200 W/MUSIC_CONTROL_SERVICE( 1814): music-control-message.c: music_control_message_add_data(64) > [31m[TID:1814]   bundle_add_str() .. [0xffffffea][0m
10-14 17:17:57.570+0200 I/MESSAGE_PORT(  489): MessagePortIpcServer.cpp: OnReadMessage(739) > _MessagePortIpcServer::OnReadMessage
10-14 17:17:57.570+0200 I/MESSAGE_PORT(  489): MessagePortIpcServer.cpp: HandleReceivedMessage(578) > _MessagePortIpcServer::HandleReceivedMessage
...
10-14 17:18:01.285+0200 W/CRASH_MANAGER(14208): worker.c: worker_job(1205) > 0614283646174150799426
