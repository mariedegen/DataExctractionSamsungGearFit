...
r2   = 0x414e9128, r3   = 0x41762114
r4   = 0xbedeb4e4, r5   = 0x4154ad30
r6   = 0x00000233, r7   = 0xbedeb378
r8   = 0xbedeb4b4, r9   = 0x4004dc84
r10  = 0x00000000, fp   = 0x00000000
ip   = 0x41757995, sp   = 0xbedeb358
...
bedcb000 bedec000 rw-p [stack]
End of Maps Information

Callstack Information (PID:10964)
Call Stack Count: 10
...
ry level 100, index 20, bg level 100
...
10-14 14:10:46.130+0200 W/CRASH_MANAGER(10835): worker.c: worker_job(1205) > 11108936461741507983035
10-14 14:10:46.855+0200 I/APP_CORE( 1063): appcore-efl.c: __do_app(429) > [APP 1063] Event: MEM_FLUSH State: PAUSED
10-14 14:10:48.905+0200 E/WMS     (  499): wms_event_handler.c: _wms_event_handler_cb_nomove_detector(21920) > _wms_event_handler_cb_nomove_detector is called
10-14 14:10:52.555+0200 W/CRASH_MANAGER(10835): worker.c: worker_job(1205) > 11109006461741507983036
10-14 14:10:57.975+0200 W/CRASH_MANAGER(10835): worker.c: worker_job(1205) > 11108786461741507983037
10-14 14:11:00.135+0200 E/PKGMGR_SERVER(11128): pkgmgr-server.c: main(2167) > package manager server start
10-14 14:11:00.280+0200 E/PKGMGR_SERVER(11128): pkgmgr-server.c: req_cb(674) > req_id=[org.example.dataextraction_-1432518114], req_type=[12], pkg_type=[rpm], pkgid=[org.example.dataextraction], args=[], cookie=[s0g4oPpTjh7++lCARp1fTzCGKjc=], backend_flag=[0]
10-14 14:11:00.285+0200 E/PKGMGR_SERVER(11129): pkgmgr-server.c: queue_job(1976) > KILL/CHECK APP, pkgid=[org.example.dataextraction]
10-14 14:11:00.290+0200 E/PKGMGR  (11125): pkgmgr.c: __check_sync_process(843) > file is can not remove[/tmp/org.example.dataextraction, -1]
10-14 14:11:00.345+0200 W/AUL_AMD (  532): amd_request.c: __request_handler(645) > __request_handler: 14
10-14 14:11:00.355+0200 W/AUL_AMD (  532): amd_request.c: __send_result_to_client(83) > __send_result_to_client, pid: -1
10-14 14:11:00.360+0200 E/PKGMGR_SERVER(11129): pkgmgr-server.c: queue_job(1998) > KILL/CHECK_APP end.
10-14 14:11:00.380+0200 E/PKGMGR_SERVER(11128): pkgmgr-server.c: sighandler(409) > child NORMAL exit [11129]
10-14 14:11:00.960+0200 W/W_INDICATOR(  714): windicator_moment_view.c: indicator_get_time_by_region(1112) > [indicator_get_time_by_region:1112] DATE & TIME is / fr_FR / 14:11  /5 / HH:mm
10-14 14:11:00.960+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1218) > [windicator_clock_changed_cb:1218] [Time] PM / 14:11
10-14 14:11:00.960+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1227) > [windicator_clock_changed_cb:1227] Not Korean
10-14 14:11:00.960+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1238) > [windicator_clock_changed_cb:1238] ptr1 : 14
10-14 14:11:00.960+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1247) > [windicator_clock_changed_cb:1247] ptr2 : 11
10-14 14:11:00.960+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1266) > [windicator_clock_changed_cb:1266] [Time] hour :  14
10-14 14:11:00.960+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1271) > [windicator_clock_changed_cb:1271] [Time] min :  11
10-14 14:11:00.960+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1278) > [windicator_clock_changed_cb:1278] [Time] 14 / 11 / 14:11
10-14 14:11:00.960+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1335) > [windicator_clock_changed_cb:1335] Hide AMPM (2)
10-14 14:11:00.965+0200 E/EFL     (  714): edje<714> edje_util.c:3770 edje_object_size_min_restricted_calc() group windicator/moment_view/charging_ui has a non-fixed part 'txt.hour'. Adding 'fixed: 1 1;' to source EDC may help. Continuing discarding faulty part.
10-14 14:11:01.310+0200 W/AUL     (11179): launch.c: app_request_to_launchpad(268) > request cmd(0) to(org.example.dataextraction)
10-14 14:11:01.315+0200 W/AUL_AMD (  532): amd_request.c: __request_handler(645) > __request_handler: 0
10-14 14:11:01.365+0200 I/AUL_AMD (  532): menu_db_util.h: _get_app_info_from_db_by_apppath(239) > path : /usr/bin/launch_app, ret : 0
10-14 14:11:01.375+0200 I/AUL_AMD (  532): menu_db_util.h: _get_app_info_from_db_by_apppath(239) > path : /bin/bash, ret : 0
10-14 14:11:01.375+0200 E/AUL_AMD (  532): amd_launch.c: _start_app(1700) > no caller appid info, ret: -1
10-14 14:11:01.375+0200 W/AUL_AMD (  532): amd_launch.c: _start_app(1710) > caller pid : 11179
10-14 14:11:01.385+0200 W/AUL_AMD (  532): amd_launch.c: _start_app(2124) > pad pid(-5)
10-14 14:11:01.390+0200 W/AUL_PAD ( 1304): launchpad.c: __launchpad_main_loop(601) > Launch on type-based process-pool
10-14 14:11:01.390+0200 W/AUL_PAD ( 1304): launchpad.c: __send_result_to_caller(272) > Check app launching
10-14 14:11:01.390+0200 E/RESOURCED(  536): block.c: block_prelaunch_state(134) > insert data org.example.dataextraction, table num : 2
10-14 14:11:01.390+0200 E/RESOURCED(  536): heart-memory.c: heart_memory_get_data(601) > hashtable heart_memory_app_list is NULL
10-14 14:11:01.475+0200 I/efl-extension(10964): efl_extension.c: eext_mod_init(40) > Init
10-14 14:11:01.490+0200 I/UXT     (10964): Uxt_ObjectManager.cpp: OnInitialized(733) > Initialized.
10-14 14:11:01.495+0200 I/CAPI_APPFW_APPLICATION(10964): app_main.c: ui_app_main(704) > app_efl_main
10-14 14:11:01.500+0200 I/CAPI_APPFW_APPLICATION(10964): app_main.c: _ui_app_appcore_create(563) > app_appcore_create
10-14 14:11:01.595+0200 W/AUL     (11179): launch.c: app_request_to_launchpad(282) > request cmd(0) result(10964)
10-14 14:11:01.600+0200 E/RESOURCED(  536): proc-main.c: proc_add_program_list(233) > not found ppi : org.example.dataextraction
10-14 14:11:02.595+0200 W/AUL_AMD (  532): amd_key.c: _key_ungrab(254) > fail(-1) to ungrab key(XF86Stop)
10-14 14:11:02.595+0200 W/AUL_AMD (  532): amd_launch.c: __grab_timeout_handler(1376) > back key ungrab error
10-14 14:11:02.650+0200 E/PKGMGR_SERVER(11128): pkgmgr-server.c: exit_server(1360) > exit_server Start [backend_status=1, queue_status=1] 
10-14 14:11:02.650+0200 E/PKGMGR_SERVER(11128): pkgmgr-server.c: main(2221) > package manager server terminated.
10-14 14:11:02.710+0200 W/AUL_PAD ( 1304): sigchild.h: __launchpad_process_sigchld(188) > dead_pid = 10964 pgid = 10964
10-14 14:11:02.730+0200 E/RESOURCED(  536): resourced-dbus.c: resourced_dbus_system_hash_drop_busname(349) > Does not exist in busname hash: :1.746
10-14 14:11:02.785+0200 E/RESOURCED( 1156): proc-stat.c: send_socket_with_repy(767) > send_socket_with_repy: read failed
10-14 14:11:02.785+0200 E/AUL     ( 1156): pkginfo.c: __get_id_bypid(212) > Failed to get the cmdline of pid, error: -1
10-14 14:11:02.785+0200 E/CAPI_APPFW_APP_MANAGER( 1156): app_manager.c: app_manager_error(77) > [app_context_get_app_context_by_pid] No such application(0xfeef0001)
10-14 14:11:02.840+0200 E/RESOURCED( 1005): proc-stat.c: send_socket_with_repy(767) > send_socket_with_repy: read failed
10-14 14:11:02.840+0200 E/AUL     ( 1005): pkginfo.c: __get_id_bypid(212) > Failed to get the cmdline of pid, error: -1
10-14 14:11:02.840+0200 E/CAPI_APPFW_APP_MANAGER( 1005): app_manager.c: app_manager_error(77) > [app_context_get_app_context_by_pid] No such application(0xfeef0001)
10-14 14:11:02.855+0200 W/AUL_PAD ( 1304): sigchild.h: __launchpad_process_sigchld(196) > after __sigchild_action
10-14 14:11:02.860+0200 I/AUL_AMD (  532): amd_main.c: __app_dead_handler(262) > __app_dead_handler, pid: 10964
10-14 14:11:02.870+0200 E/RESOURCED(  536): resourced-dbus.c: resourced_dbus_system_hash_drop_busname(349) > Does not exist in busname hash: :1.747
10-14 14:11:03.280+0200 E/EFL     (11183): elementary<11183> elm_main.c:558 elm_quicklaunch_init() eet_init done.
10-14 14:11:03.280+0200 E/EFL     (11183): elementary<11183> elm_main.c:560 elm_quicklaunch_init() ecore_init done.
10-14 14:11:03.330+0200 E/EFL     (11183): elementary<11183> elm_main.c:572 elm_quicklaunch_init() ecore_file_init done.
10-14 14:11:03.330+0200 E/EFL     (11183): elementary<11183> elm_main.c:595 elm_quicklaunch_init() _elm_screen_status_init done.
10-14 14:11:03.385+0200 E/EFL     (11183): elementary<11183> elm_main.c:625 elm_quicklaunch_init() e_dbus_init done.
10-14 14:11:03.385+0200 E/EFL     (11183): elementary<11183> elm_main.c:649 elm_quicklaunch_sub_init() evas_init done.
10-14 14:11:03.385+0200 E/EFL     (11183): elementary<11183> elm_main.c:651 elm_quicklaunch_sub_init() edje_init done.
10-14 14:11:03.385+0200 E/EFL     (11183): elementary<11183> elm_main.c:653 elm_quicklaunch_sub_init() _elm_module_init done.
10-14 14:11:03.385+0200 E/EFL     (11183): elementary<11183> elm_config.c:2759 _elm_config_init() _elm_config_init step 1 done.
10-14 14:11:03.425+0200 E/EFL     (11183): elementary<11183> elm_config.c:2767 _elm_config_init() _elm_config_init step 2 done.
10-14 14:11:03.425+0200 E/EFL     (11183): elementary<11183> elm_config.c:2771 _elm_config_init() _elm_config_init step 3 done.
10-14 14:11:03.425+0200 E/EFL     (11183): elementary<11183> elm_main.c:655 elm_quicklaunch_sub_init() _elm_config_init done.
10-14 14:11:03.485+0200 E/EFL     (11183): elementary<11183> elm_config.c:2811 _elm_config_sub_init() ecore_x_init done.
10-14 14:11:03.515+0200 E/EFL     (11183): elementary<11183> elm_config.c:2866 _elm_config_sub_init() _config_sub_apply done.
10-14 14:11:03.515+0200 E/EFL     (11183): elementary<11183> elm_main.c:657 elm_quicklaunch_sub_init() _elm_config_sub_init done.
10-14 14:11:03.515+0200 E/EFL     (11183): elementary<11183> elm_main.c:659 elm_quicklaunch_sub_init() ecore_evas_init done.
10-14 14:11:03.515+0200 E/EFL     (11183): elementary<11183> elm_main.c:666 elm_quicklaunch_sub_init() ecore_con_init done.
10-14 14:11:03.515+0200 E/EFL     (11183): elementary<11183> elm_main.c:668 elm_quicklaunch_sub_init() ecore_con_url_init done.
10-14 14:11:03.515+0200 E/EFL     (11183): elementary<11183> elm_main.c:671 elm_quicklaunch_sub_init() _elm_ews_wm_init done.
10-14 14:11:03.515+0200 I/AUL_PAD (11183): launchpad_loader.c: main(580) > [candidate] elm init, returned: 1
10-14 14:11:07.375+0200 W/CRASH_MANAGER(10835): worker.c: worker_job(1205) > 1110964646174150798306
