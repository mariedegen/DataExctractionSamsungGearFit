...
PID: 14980
Date: 2017-10-14 17:20:59+0200
Executable File Path: /opt/usr/apps/org.example.dataextraction/bin/dataextraction
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 14980, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00003a84
r2   = 0x00000006, r3   = 0x00003a84
r4   = 0x00000006, r5   = 0x000f5528
r6   = 0x4040cbec, r7   = 0x0000010c
r8   = 0x42f931a0, r9   = 0x00000002
r10  = 0x0000007f, fp   = 0xbec33c20
ip   = 0x42f93660, sp   = 0xbec334e8
...
Threads: 7
PID = 14980 TID = 14980
14980 14982 14983 14993 14994 14995 14996 
...
4003a000 4003d000 rw-p [stack:14983]
...
4368a000 43e89000 rw-p [stack:14982]
441d0000 441d1000 r-xp /usr/lib/evas/modules/loaders/eet/linux-gnueabi-armv7l-1.7.99/module.so
441da000 449d9000 rw-p [stack:14993]
449da000 451d9000 rw-p [stack:14994]
451da000 459d9000 rw-p [stack:14995]
459da000 461d9000 rw-p [stack:14996]
bec14000 bec35000 rw-p [stack]
End of Maps Information

Callstack Information (PID:14980)
Call Stack Count: 1
...
0.800+0200 W/W_HOME  ( 1063): dbox.c: _dbus_rotation_cb(1341) > angle changed:90
10-14 17:21:10.810+0200 W/MUSIC_PLAYER(15070): mp-conf.c: mp_conf_is_ios_connected(187) > [33m[TID:15070]   vendor : LO[0m
...
10-14 17:21:14.215+0200 W/CRASH_MANAGER(14943): worker.c: worker_job(1205) > 0614980646174150799445
