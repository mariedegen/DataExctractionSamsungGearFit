...
PID: 11399
Date: 2017-10-14 17:09:15+0200
Executable File Path: /opt/usr/apps/org.example.dataextraction/bin/dataextraction
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 11399, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00002c87
r2   = 0x00000006, r3   = 0x00002c87
r4   = 0x00000006, r5   = 0x000f5528
r6   = 0x4040cbec, r7   = 0x0000010c
r8   = 0x42f931a0, r9   = 0x00000002
r10  = 0x0000007f, fp   = 0xbe94dc20
ip   = 0x42f93660, sp   = 0xbe94d4e8
...
Threads: 7
PID = 11399 TID = 11399
11399 11400 11401 11410 11411 11412 11413 
...
4003a000 4003d000 rw-p [stack:11401]
...
4368a000 43e89000 rw-p [stack:11400]
441d0000 441d1000 r-xp /usr/lib/evas/modules/loaders/eet/linux-gnueabi-armv7l-1.7.99/module.so
441da000 449d9000 rw-p [stack:11410]
449da000 451d9000 rw-p [stack:11411]
451da000 459d9000 rw-p [stack:11412]
45b01000 46300000 rw-p [stack:11413]
be92e000 be94f000 rw-p [stack]
...
--------- beginning of /dev/log_main
 17:09:28.235+0200 I/CAPI_WATCH_APPLICATION( 1130): watch_app_main.c: _watch_core_time_tick(306) > _watch_core_time_tick
...
10-14 17:09:42.065+0200 W/CRASH_MANAGER(11039): worker.c: worker_job(1205) > 0611399646174150799375
