...
r0   = 0x43e02c10, r1   = 0x00000001
r2   = 0x43e00010, r3   = 0x3c3bef00
r4   = 0xbe9632fc, r5   = 0x4005ad30
r6   = 0x00000233, r7   = 0xbe963218
r8   = 0xbe9632cc, r9   = 0x404bec84
r10  = 0x00000000, fp   = 0x00000000
ip   = 0x0000010c, sp   = 0xbe9631e8
...
43524000 43e00000 rw-p [stack:20920]
be943000 be964000 rw-p [stack]
End of Maps Information

Callstack Information (PID:20918)
Call Stack Count: 8
...
, powersaving : 0, apptray state : 1, apptray visibility : 1, apptray edit visibility : 0
10-26 13:15:10.315+0200 W/W_HOME  (  769): event_manager.c: _state_control(194) > control:1, app_state:1 win_state:0(1) pm_state:1 home_visible:0 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 1, apptray visibility : 1, apptray edit visibility : 0
10-26 13:15:10.335+0200 W/WATCH_CORE(  806): appcore-watch.c: __signal_context_handler(1219) > _signal_context_handler: type: 0, state: 3
10-26 13:15:10.335+0200 I/WATCH_CORE(  806): appcore-watch.c: __signal_context_handler(1236) > Call the time_tick_cb
10-26 13:15:10.335+0200 I/CAPI_WATCH_APPLICATION(  806): watch_app_main.c: _watch_core_time_tick(306) > _watch_core_time_tick
10-26 13:15:10.340+0200 E/RESOURCED(  566): heart-memory.c: heart_memory_get_data(601) > hashtable heart_memory_app_list is NULL
10-26 13:15:10.345+0200 E/wnoti-service(  876): wnoti-db-utility.c: context_wearonoff_status_cb(1753) > status changed from 1 to 2 
10-26 13:15:10.350+0200 E/WMS     (  519): wms_event_handler.c: _wms_event_handler_cb_wearonoff_monitor(21860) > wear_monitor_status update[0] = 1 -> 2
10-26 13:15:10.360+0200 I/CAPI_APPFW_APPLICATION(20930): app_main.c: app_efl_main(129) > app_efl_main
10-26 13:15:10.360+0200 W/W_HOME  (  769): dbus.c: _dbus_message_recv_cb(240) > Coordination rotation changed received
10-26 13:15:10.360+0200 W/W_HOME  (  769): dbox.c: _dbus_rotation_cb(1344) > invalid angle, skipped:0
10-26 13:15:10.365+0200 I/CAPI_APPFW_APPLICATION(20930): app_main.c: app_appcore_create(152) > app_appcore_create
10-26 13:15:10.400+0200 E/RESOURCED(  566): proc-main.c: proc_add_program_list(233) > not found ppi : com.samsung.w-clock-viewer
10-26 13:15:10.405+0200 W/AUL     (  732): launch.c: app_request_to_launchpad(282) > request cmd(0) result(20930)
10-26 13:15:10.405+0200 W/STARTER (  732): clock-mgr.c: _on_lcd_signal_receive_cb(1626) > [_on_lcd_signal_receive_cb:1626] _on_lcd_signal_receive_cb, 1626, Pre LCD on by [charge] after screen off time [897]ms
10-26 13:15:10.405+0200 W/STARTER (  732): clock-mgr.c: _pre_lcd_on(1346) > [_pre_lcd_on:1346] Will LCD ON as reserved app[(null)] alpm mode[0] charger[1]
10-26 13:15:10.425+0200 I/AUL_AMD (  564): menu_db_util.h: _get_app_info_from_db_by_apppath(239) > path : /usr/bin/amd, ret : 0
10-26 13:15:10.435+0200 I/AUL_AMD (  564): menu_db_util.h: _get_app_info_from_db_by_apppath(239) > path : /usr/bin/amd, ret : 0
10-26 13:15:10.435+0200 E/AUL_AMD (  564): amd_launch.c: _start_app(1700) > no caller appid info, ret: -1
10-26 13:15:10.435+0200 W/AUL_AMD (  564): amd_launch.c: _start_app(1710) > caller pid : 564
10-26 13:15:10.445+0200 W/AUL_AMD (  564): amd_launch.c: start_process(580) > child process: 20949
10-26 13:15:10.470+0200 E/ALARM_MANAGER(  494): alarm-manager.c: __is_cached_cookie(228) > Find cached cookie for [732].
10-26 13:15:10.470+0200 E/ALARM_MANAGER(  494): alarm-manager.c: __alarm_remove_from_list(562) > [alarm-server]:Remove alarm id(457761716)
10-26 13:15:10.470+0200 E/ALARM_MANAGER(  494): alarm-manager.c: __rtc_set(323) > [alarm-server]ALARM_CLEAR ioctl is successfully done.
10-26 13:15:10.470+0200 E/ALARM_MANAGER(  494): alarm-manager.c: __rtc_set(330) > Setted RTC Alarm date/time is 26-10-2017, 12:45:00 (UTC).
10-26 13:15:10.470+0200 E/ALARM_MANAGER(  494): alarm-manager.c: __rtc_set(345) > [alarm-server]RTC ALARM_SET ioctl is successfully done.
10-26 13:15:10.470+0200 E/ALARM_MANAGER(  494): alarm-manager.c: alarm_manager_alarm_delete(2426) > alarm_id[457761716] is removed.
10-26 13:15:10.490+0200 W/SHealth_Service( 1085): ContextRestingHeartrateProxy.cpp: OnRestingHrUpdatedCB(347) > [1;40;33mhrValue: 1008[0;m
10-26 13:15:10.500+0200 E/CAPI_APPFW_APPLICATION_PREFERENCE( 1085): preference.c: _preference_check_retry_err(507) > key(test_healthy_pace), check retry err: -21/(2/No such file or directory).
10-26 13:15:10.505+0200 E/CAPI_APPFW_APPLICATION_PREFERENCE( 1085): preference.c: _preference_get_key(1101) > _preference_get_key(test_healthy_pace) step(-17825744) failed(2 / No such file or directory)
10-26 13:15:10.510+0200 W/W_HOME  (  769): gesture.c: _manual_render_disable_timer_cb(143) > timeout callback expired
...
10-26 13:15:16.345+0200 W/CRASH_MANAGER(20356): worker.c: worker_job(1205) > 1120918646174150901650
