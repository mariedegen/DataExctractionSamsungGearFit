...
r0   = 0x43e03dd0, r1   = 0x00000001
r2   = 0x43e00010, r3   = 0x5b421400
r4   = 0xbea974d4, r5   = 0x4144ad30
r6   = 0x00000233, r7   = 0xbea97400
r8   = 0xbea974a4, r9   = 0x4004dc84
r10  = 0x00000000, fp   = 0x00000000
ip   = 0x404e5a00, sp   = 0xbea973d0
lr   = 0x404e5ab4, pc   = 0x41646718
cpsr = 0x60000030
...
41935000 41937000 rw-p [heap]
41937000 41a4d000 rw-p [heap]
41a4d000 41b8a000 r-xp /usr/lib/libicui18n.so.51.1
41b9a000 41c7e000 r-xp /usr/lib/libicuuc.so.51.1
4321c000 43238000 r-xp /usr/lib/libpkgmgr-client.so.0.1.68
43241000 43244000 r-xp /usr/lib/libcapi-media-image-util.so.0.3.5
4324c000 4324d000 r-xp /usr/lib/libsecurity-privilege-checker.so.1.0.1
43256000 4325e000 r-xp /usr/lib/libdrm.so.2.4.0
43266000 43268000 r-xp /usr/lib/libdri2.so.0.0.0
43270000 43277000 r-xp /usr/lib/libpkgmgr_installer_client.so.0.1.0
43280000 43282000 r-xp /usr/lib/libpkgmgr_installer_status_broadcast_server.so.0.1.0
4328a000 43291000 r-xp /usr/lib/libminizip.so.1.0.0
43299000 4329f000 r-xp /usr/lib/libmmutil_jpeg.so.0.0.0
432a7000 432ac000 r-xp /usr/lib/libmmutil_imgp.so.0.0.0
432b4000 432d5000 r-xp /usr/lib/libexif.so.12.3.3
432e8000 432ea000 r-xp /usr/lib/libttrace.so.1.1
432f2000 432f7000 r-xp /usr/lib/libcapi-media-tool.so.0.1.5
432ff000 433c9000 r-xp /usr/lib/libCOREGL.so.4.0
435dc000 43e00000 rw-p [stack:19247]
bea77000 bea98000 rw-p [stack]
End of Maps Information

Callstack Information (PID:19236)
Call Stack Count: 9
 0: start_bt_server + 0x13 (0x41646718) [/opt/usr/apps/org.example.dataextraction/bin/dataextraction] + 0x3718
 1: app_create + 0x38 (0x41644ffd) [/opt/usr/apps/org.example.dataextraction/bin/dataextraction] + 0x1ffd
 ...
 5: main + 0x10e (0x41644f5f) [/opt/usr/apps/org.example.dataextraction/bin/dataextraction] + 0x1f5f
...
(1004) > source:1 event:80001
10-26 13:10:59.090+0200 I/wnotib  (  769): w-notification-board-broker-main.c: _wnb_view_event_handler(828) > Home view event: 0x80001
10-26 13:10:59.090+0200 I/wnotib  (  769): w-notification-board-noti-manager.c: wnb_nm_app_tray_changed(1473) > is_app_tray_displayed: 0
10-26 13:10:59.095+0200 E/ALARM_MANAGER(  494): alarm-manager.c: __display_unlock_state(1912) > Unlock LCD OFF is successfully done
10-26 13:10:59.100+0200 E/ALARM_MANAGER(  494): alarm-manager.c: __is_cached_cookie(228) > Find cached cookie for [732].
10-26 13:10:59.100+0200 E/ALARM_MANAGER(  494): alarm-manager.c: __alarm_remove_from_list(562) > [alarm-server]:Remove alarm id(2054309840)
...
10-26 13:11:09.000+0200 W/CRASH_MANAGER(18479): worker.c: worker_job(1205) > 1119236646174150901623
