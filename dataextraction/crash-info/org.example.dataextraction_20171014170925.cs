...
r0   = 0xef534050, r1   = 0x401cee58
r2   = 0xbec80ccc, r3   = 0xbec80d31
r4   = 0x401cee58, r5   = 0xef534050
r6   = 0x402c9b88, r7   = 0xbec80d40
r8   = 0x00000041, r9   = 0x408e3824
r10  = 0x42fbce00, fp   = 0x00000000
ip   = 0x401e5c20, sp   = 0xbec80c48
...
Threads: 7
PID = 11505 TID = 11505
11505 11506 11507 11516 11517 11518 11519 
...
4003a000 4003d000 rw-p [stack:11507]
...
4368a000 43e89000 rw-p [stack:11506]
441d0000 441d1000 r-xp /usr/lib/evas/modules/loaders/eet/linux-gnueabi-armv7l-1.7.99/module.so
441da000 449d9000 rw-p [stack:11516]
449da000 451d9000 rw-p [stack:11517]
451da000 459d9000 rw-p [stack:11518]
459da000 461d9000 rw-p [stack:11519]
bec61000 bec82000 rw-p [stack]
End of Maps Information

Callstack Information (PID:11505)
Call Stack Count: 16
 ...
 2: on_sensor_event + 0xc0 (0x40001e69) [/opt/usr/apps/org.example.dataextraction/bin/dataextraction] + 0x1e69
...
13: main + 0x10e (0x40001653) [/opt/usr/apps/org.example.dataextraction/bin/dataextraction] + 0x1653
14: __libc_start_main + 0x114 (0x402fe82c) [/lib/libc.so.6] + 0x1782c
15: (0x400013bc) [/opt/usr/apps/org.example.dataextraction/bin/dataextraction] + 0x13bc
End of Call Stack
...
--------- beginning of /dev/log_main
 win_state:1(1) pm_state:1 home_visible:0 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 0, apptray visibility : 1, apptray edit visibility : 0
...
10-14 17:09:53.875+0200 W/CRASH_MANAGER(11039): worker.c: worker_job(1205) > 11114726461741507993760
10-14 17:09:56.060+0200 W/CRASH_MANAGER(11039): worker.c: worker_job(1205) > 11114716461741507993762
10-14 17:09:57.715+0200 W/W_CLOCK_VIEWER(11503): clock-viewer.c: __clock_viewer_lcdoff_cb(499) >  event pre lcdoff[1]
10-14 17:09:57.715+0200 W/W_CLOCK_VIEWER(11503): clock-viewer.c: __clock_viewer_lcdoff_cb(510) >  Enter to charger alpm mode
10-14 17:09:57.715+0200 W/W_CLOCK_VIEWER(11503): clock-viewer.c: _clock_viewer_set_black_cover(801) >  Set black cover[1] ani[0]
10-14 17:09:57.715+0200 W/W_CLOCK_VIEWER(11503): clock-viewer.c: _clock_viewer_show_charging(946) >  clock start in charging >> [0]
10-14 17:09:57.730+0200 W/WATCH_CORE( 1130): appcore-watch.c: __signal_lcd_status_handler(1157) > signal_lcd_status_signal: LCDOff
10-14 17:09:57.730+0200 W/W_HOME  ( 1063): dbus.c: _dbus_message_recv_cb(204) > LCD off
10-14 17:09:57.730+0200 W/W_HOME  ( 1063): gesture.c: _manual_render_cancel_schedule(229) > cancel schedule, manual render
10-14 17:09:57.730+0200 W/W_HOME  ( 1063): gesture.c: _manual_render_disable_timer_del(155) > timer del
10-14 17:09:57.730+0200 W/W_HOME  ( 1063): gesture.c: _manual_render_enable(136) > 1
10-14 17:09:57.730+0200 W/W_HOME  ( 1063): event_manager.c: _lcd_off_cb(704) > lcd state: 0
10-14 17:09:57.730+0200 W/W_HOME  ( 1063): event_manager.c: _state_control(194) > control:4, app_state:2 win_state:1(0) pm_state:0 home_visible:0 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 1, apptray visibility : 1, apptray edit visibility : 0
10-14 17:09:57.745+0200 W/STARTER (  705): clock-mgr.c: _on_lcd_signal_receive_cb(1648) > [_on_lcd_signal_receive_cb:1648] _on_lcd_signal_receive_cb, 1648, Pre LCD off by [timeout]
10-14 17:09:57.745+0200 W/STARTER (  705): clock-mgr.c: _pre_lcd_off(1426) > [_pre_lcd_off:1426] Will LCD OFF as wake_up_setting[1]
10-14 17:09:57.745+0200 E/STARTER (  705): scontext_util.c: scontext_util_handle_lock_state(64) > [scontext_util_handle_lock_state:64] wear state[0],bPossible [0]
10-14 17:09:57.745+0200 W/STARTER (  705): clock-mgr.c: _check_reserved_popup_status(321) > [_check_reserved_popup_status:321] Current reserved apps status : 0
10-14 17:09:57.745+0200 W/STARTER (  705): clock-mgr.c: _check_reserved_apps_status(357) > [_check_reserved_apps_status:357] Current reserved apps status : 0
10-14 17:09:57.945+0200 W/SHealth_Common( 1156): SystemUtil.cpp: OnDeviceStatusChanged(1039) > [1;35mlcdState:3[0;m
10-14 17:09:57.950+0200 W/W_INDICATOR(  714): windicator_util.c: _pm_state_changed_cb(805) > [_pm_state_changed_cb:805] Charger connected, so show charger watch
10-14 17:09:58.000+0200 I/APP_CORE(  714): appcore-efl.c: __do_app(429) > [APP 714] Event: PAUSE State: RUNNING
10-14 17:09:58.000+0200 I/CAPI_APPFW_APPLICATION(  714): app_main.c: app_appcore_pause(202) > app_appcore_pause
10-14 17:09:58.005+0200 I/APP_CORE(  714): appcore-efl.c: __visibility_cb(868) > LCD status is off, skip the AE_RESUME event
10-14 17:09:58.025+0200 W/AUL_AMD (  532): amd_key.c: _key_ungrab(254) > fail(-1) to ungrab key(XF86Stop)
10-14 17:09:58.030+0200 W/AUL_AMD (  532): amd_launch.c: __e17_status_handler(2292) > back key ungrab error
10-14 17:09:58.035+0200 W/AUL_AMD (  532): amd_key.c: _key_ungrab(254) > fail(-1) to ungrab key(XF86Stop)
10-14 17:09:58.035+0200 W/AUL_AMD (  532): amd_launch.c: __e17_status_handler(2292) > back key ungrab error
10-14 17:09:58.050+0200 E/W_INDICATOR(  714): windicator_util.c: _ecore_event_client_message_cb(1004) > [_ecore_event_client_message_cb:1004] _ecore_event_client_message_cb
10-14 17:09:58.060+0200 W/SHealth_Common( 1005): SystemUtil.cpp: OnDeviceStatusChanged(1039) > [1;35mlcdState:3[0;m
10-14 17:09:58.060+0200 W/SHealth_Service( 1005): SHealthServiceController.cpp: OnSystemUtilLcdStateChanged(676) > [1;35m ###[0;m
10-14 17:09:58.145+0200 W/W_CLOCK_VIEWER(11503): clock-viewer.c: __clock_viewer_clockend_timer_cb(235) >  clock end << [1]
10-14 17:09:58.180+0200 W/STARTER (  705): clock-mgr.c: _on_lcd_signal_receive_cb(1659) > [_on_lcd_signal_receive_cb:1659] _on_lcd_signal_receive_cb, 1659, Post LCD off by [timeout]
10-14 17:09:58.180+0200 W/STARTER (  705): clock-mgr.c: _post_lcd_off(1558) > [_post_lcd_off:1558] LCD OFF as reserved app[(null)] alpm mode[0] charger[1]
10-14 17:09:58.180+0200 W/STARTER (  705): clock-mgr.c: _post_lcd_off(1565) > [_post_lcd_off:1565] Current reserved apps status : 0
10-14 17:09:58.180+0200 W/STARTER (  705): clock-mgr.c: _post_lcd_off(1583) > [_post_lcd_off:1583] raise homescreen after 20 sec. home_visible[0]
10-14 17:09:58.180+0200 E/ALARM_MANAGER(  705): alarm-lib.c: alarmmgr_add_alarm_withcb(1174) > trigger_at_time(20), start(14-10-2017, 17:10:18), repeat(1), interval(20), type(-1073741822)
10-14 17:09:58.195+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __is_cached_cookie(228) > Find cached cookie for [705].
10-14 17:09:58.195+0200 W/W_CLOCK_VIEWER(11503): clock-viewer.c: __clock_viewer_lcdoff_completed_cb(598) >  event lcdoff completed[1][0]
10-14 17:09:58.195+0200 W/W_CLOCK_VIEWER(11503): clock-viewer.c: __clock_viewer_lcdoff_completed_cb(611) >  Enter to charger alpm mode
10-14 17:09:58.205+0200 E/ALARM_MANAGER(11503): alarm-lib.c: alarmmgr_add_alarm_withcb(1174) > trigger_at_time(62), start(14-10-2017, 17:11:00), repeat(1), interval(120), type(-1073741822)
10-14 17:09:58.240+0200 E/ALARM_MANAGER(  484): alarm-manager-schedule.c: _alarm_next_duetime(509) > alarm_id: 1815389888, next duetime: 1507993818
10-14 17:09:58.240+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __alarm_add_to_list(483) > [alarm-server]: After add alarm_id(1815389888)
10-14 17:09:58.240+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __alarm_create(1048) > [alarm-server]:alarm_context.c_due_time(1508014052), due_time(1507993818)
10-14 17:09:58.240+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __rtc_set(323) > [alarm-server]ALARM_CLEAR ioctl is successfully done.
10-14 17:09:58.240+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __rtc_set(330) > Setted RTC Alarm date/time is 14-10-2017, 15:10:18 (UTC).
10-14 17:09:58.240+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __rtc_set(345) > [alarm-server]RTC ALARM_SET ioctl is successfully done.
10-14 17:09:58.240+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __save_module_log(1765) > The file is not ready.
10-14 17:09:58.240+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __save_module_log(1765) > The file is not ready.
10-14 17:09:58.240+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __is_cached_cookie(228) > Find cached cookie for [11503].
10-14 17:09:58.270+0200 E/ALARM_MANAGER(  484): alarm-manager-schedule.c: _alarm_next_duetime(509) > alarm_id: 1815389889, next duetime: 1507993860
10-14 17:09:58.270+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __alarm_add_to_list(483) > [alarm-server]: After add alarm_id(1815389889)
10-14 17:09:58.275+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __alarm_create(1048) > [alarm-server]:alarm_context.c_due_time(1507993818), due_time(1507993860)
10-14 17:09:58.275+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __rtc_set(323) > [alarm-server]ALARM_CLEAR ioctl is successfully done.
10-14 17:09:58.275+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __rtc_set(330) > Setted RTC Alarm date/time is 14-10-2017, 15:10:18 (UTC).
10-14 17:09:58.275+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __rtc_set(345) > [alarm-server]RTC ALARM_SET ioctl is successfully done.
10-14 17:09:58.275+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __save_module_log(1765) > The file is not ready.
10-14 17:09:58.275+0200 E/ALARM_MANAGER(  484): alarm-manager.c: __save_module_log(1765) > The file is not ready.
10-14 17:09:58.700+0200 W/W_CLOCK_VIEWER(11503): clock-viewer.c: __clock_viewer_black_cover_timer_cb(214) >  Remove black screen
10-14 17:09:58.700+0200 W/W_CLOCK_VIEWER(11503): clock-viewer.c: _clock_viewer_set_black_cover(801) >  Set black cover[0] ani[0]
10-14 17:10:00.835+0200 W/W_INDICATOR(  714): windicator_moment_view.c: indicator_get_time_by_region(1112) > [indicator_get_time_by_region:1112] DATE & TIME is / fr_FR / 17:10  /5 / HH:mm
10-14 17:10:00.835+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1218) > [windicator_clock_changed_cb:1218] [Time] PM / 17:10
10-14 17:10:00.835+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1227) > [windicator_clock_changed_cb:1227] Not Korean
10-14 17:10:00.835+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1238) > [windicator_clock_changed_cb:1238] ptr1 : 17
10-14 17:10:00.835+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1247) > [windicator_clock_changed_cb:1247] ptr2 : 10
10-14 17:10:00.835+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1266) > [windicator_clock_changed_cb:1266] [Time] hour :  17
10-14 17:10:00.835+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1271) > [windicator_clock_changed_cb:1271] [Time] min :  10
10-14 17:10:00.835+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1278) > [windicator_clock_changed_cb:1278] [Time] 17 / 10 / 17:10
10-14 17:10:00.835+0200 W/W_INDICATOR(  714): windicator_moment_view.c: windicator_clock_changed_cb(1335) > [windicator_clock_changed_cb:1335] Hide AMPM (2)
10-14 17:10:00.840+0200 E/EFL     (  714): edje<714> edje_util.c:3770 edje_object_size_min_restricted_calc() group windicator/moment_view/charging_ui has a non-fixed part 'txt.hour'. Adding 'fixed: 1 1;' to source EDC may help. Continuing discarding faulty part.
10-14 17:10:03.010+0200 I/APP_CORE(  714): appcore-efl.c: __do_app(429) > [APP 714] Event: MEM_FLUSH State: PAUSED
10-14 17:10:04.940+0200 W/CRASH_MANAGER(11039): worker.c: worker_job(1205) > 1111505646174150799376
