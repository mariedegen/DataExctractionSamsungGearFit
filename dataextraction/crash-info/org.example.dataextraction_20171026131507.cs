...
r0   = 0x4178fe40, r1   = 0x00000001
r2   = 0x4059d250, r3   = 0x506fa300
r4   = 0xbee404d4, r5   = 0x4144ad30
r6   = 0x00000233, r7   = 0xbee403f0
r8   = 0xbee404a4, r9   = 0x4004dc84
r10  = 0x00000000, fp   = 0x00000000
ip   = 0x00000021, sp   = 0xbee403c0
...
41694000 4169c000 r-xp /usr/lib/libcapi-system-system-settings.so.0.0.2
4169d000 417b5000 rw-p [heap]
417b5000 417b9000 r-xp /usr/lib/libcapi-system-sensor.so.0.1.18
417c2000 417e3000 r-xp /usr/lib/libefl-extension.so.0.1.0
417ec000 41826000 r-xp /usr/lib/libbluetooth-api.so.1.0.0
4182f000 41848000 r-xp /usr/lib/libprivacy-manager-client.so.0.0.8
41850000 41855000 r-xp /usr/lib/libcapi-system-info.so.0.2.0
4185d000 41887000 r-xp /usr/lib/libsensor.so.1.9.6
41890000 418a2000 r-xp /usr/lib/libefl-assist.so.0.1.0
418aa000 41962000 r-xp /usr/lib/libcairo.so.2.11200.14
4196d000 41970000 r-xp /usr/lib/libsyspopup_caller.so.0.1.0
41978000 4197e000 r-xp /usr/lib/libcapi-appfw-app-manager.so.0.2.8
41987000 4198f000 r-xp /usr/lib/libcapi-appfw-package-manager.so.0.0.59
41997000 419a1000 r-xp /usr/lib/libsensord-shared.so
419aa000 419bc000 r-xp /usr/lib/libtts.so
419c4000 419e6000 r-xp /usr/lib/libui-extension.so.0.1.0
419ef000 419f6000 r-xp /usr/lib/libtbm.so.1.0.0
419fe000 41a0c000 r-xp /usr/lib/libGLESv2.so.2.0
41a15000 41a16000 r-xp /usr/lib/libxcb-shm.so.0.0.0
41a1f000 41a25000 r-xp /usr/lib/libxcb-render.so.0.0.0
41a2d000 41a30000 r-xp /usr/lib/libEGL.so.1.4
41a38000 41a45000 r-xp /usr/lib/libail.so.0.1.0
41a4e000 41b8b000 r-xp /usr/lib/libicui18n.so.51.1
41b9b000 41c7f000 r-xp /usr/lib/libicuuc.so.51.1
4321d000 43239000 r-xp /usr/lib/libpkgmgr-client.so.0.1.68
43242000 43245000 r-xp /usr/lib/libcapi-media-image-util.so.0.3.5
4324d000 4324e000 r-xp /usr/lib/libsecurity-privilege-checker.so.1.0.1
43257000 4325f000 r-xp /usr/lib/libdrm.so.2.4.0
43267000 43269000 r-xp /usr/lib/libdri2.so.0.0.0
43271000 43278000 r-xp /usr/lib/libpkgmgr_installer_client.so.0.1.0
43281000 43283000 r-xp /usr/lib/libpkgmgr_installer_status_broadcast_server.so.0.1.0
4328b000 43292000 r-xp /usr/lib/libminizip.so.1.0.0
4329a000 432a0000 r-xp /usr/lib/libmmutil_jpeg.so.0.0.0
432a8000 432ad000 r-xp /usr/lib/libmmutil_imgp.so.0.0.0
432b5000 432d6000 r-xp /usr/lib/libexif.so.12.3.3
432e9000 432eb000 r-xp /usr/lib/libttrace.so.1.1
432f3000 432f8000 r-xp /usr/lib/libcapi-media-tool.so.0.1.5
43300000 433ca000 r-xp /usr/lib/libCOREGL.so.4.0
435dd000 43e00000 rw-p [stack:20926]
bee20000 bee41000 rw-p [stack]
End of Maps Information

Callstack Information (PID:20916)
Call Stack Count: 9
...
26 13:15:10.510+0200 W/W_HOME  (  769): gesture.c: _manual_render_disable_timer_cb(143) > timeout callback expired
...
10-26 13:15:34.285+0200 W/CRASH_MANAGER(20356): worker.c: worker_job(1205) > 1120916646174150901650
