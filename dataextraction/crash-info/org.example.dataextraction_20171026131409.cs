...
r0   = 0x43f02680, r1   = 0x00000001
r2   = 0x43f00010, r3   = 0x7699d400
r4   = 0xbeab94d4, r5   = 0x4154ad30
r6   = 0x00000233, r7   = 0xbeab9400
r8   = 0xbeab94a4, r9   = 0x4004dc84
r10  = 0x00000000, fp   = 0x00000000
ip   = 0x404e5a00, sp   = 0xbeab93d0
...
436c5000 43f00000 rw-p [stack:20420]
bea99000 beaba000 rw-p [stack]
End of Maps Information

Callstack Information (PID:20369)
Call Stack Count: 9
...
ger.c: __rtc_set(345) > [alarm-server]RTC ALARM_SET ioctl is successfully done.
10-26 13:14:02.620+0200 E/APP_CORE(  735): appcore-efl.c: __show_cb(783) >  This is child window. Skip!!! WIN:200000a
10-26 13:14:02.650+0200 E/W_INDICATOR(  735): windicator_util.c: _ecore_event_client_message_cb(1004) > [_ecore_event_client_message_cb:1004] _ecore_event_client_message_cb
10-26 13:14:02.650+0200 W/APP_CORE(  735): appcore-efl.c: __hide_cb(809) > [EVENT_TEST][EVENT] GET HIDE EVENT!!!. WIN:200000a
10-26 13:14:02.690+0200 W/STARTER (  732): clock-mgr.c: _charger_status_setting_changed_cb(890) > [_charger_status_setting_changed_cb:890] charger status is changed to [0] ambient[0]
10-26 13:14:02.690+0200 W/AUL     (  732): launch.c: app_request_to_launchpad(268) > request cmd(4) to(19444)
10-26 13:14:02.690+0200 W/AUL_AMD (  564): amd_request.c: __request_handler(645) > __request_handler: 4
10-26 13:14:02.695+0200 I/APP_CORE(19444): appcore-efl.c: __do_app(429) > [APP 19444] Event: TERMINATE State: RUNNING
10-26 13:14:02.695+0200 W/AUL_AMD (  564): amd_launch.c: __reply_handler(922) > listen fd(20) , send fd(15), pid(19444), cmd(4)
10-26 13:14:02.700+0200 W/AUL_AMD (  564): amd_request.c: __request_handler(645) > __request_handler: 22
10-26 13:14:02.700+0200 W/AUL_AMD (  564): amd_request.c: __request_handler(916) > app status : 4
10-26 13:14:02.700+0200 W/wnotib  (  769): w-notification-board-broker-main.c: _wnb_charger_status_changed_cb(437) > 
10-26 13:14:02.700+0200 W/wnotib  (  769): w-notification-board-panel-summary.c: wnb_summary_draw_summary_view(1619) > num_categoreis: 0
10-26 13:14:02.700+0200 I/wnotib  (  769): w-notification-board-panel-summary.c: _wnb_summary_draw_static_empty_view(1246) > Use existing static_empty_view.
10-26 13:14:02.700+0200 W/wnotib  (  769): w-notification-board-panel-summary.c: wnb_summary_draw_summary_view(1640) > current_summary_type: 1, new_summary_type: 1
10-26 13:14:02.700+0200 W/AUL     (  732): launch.c: app_request_to_launchpad(282) > request cmd(4) result(0)
10-26 13:14:02.700+0200 E/APP_CORE(19444): appcore.c: __del_vconf(429) > [FAILED]vconfkey_ignore_key_changed
10-26 13:14:02.705+0200 I/APP_CORE(19444): appcore-efl.c: __after_loop(1087) > Legacy lifecycle: 0
10-26 13:14:02.705+0200 I/CAPI_APPFW_APPLICATION(19444): app_main.c: app_appcore_terminate(177) > app_appcore_terminate
10-26 13:14:02.705+0200 E/EFL     (19444): ecore<19444> ecore.c:573 _ecore_magic_fail() 
10-26 13:14:02.705+0200 E/EFL     (19444): *** ECORE ERROR: Ecore Magic Check Failed!!!
10-26 13:14:02.705+0200 E/EFL     (19444): *** IN FUNCTION: ecore_timer_del()
10-26 13:14:02.705+0200 E/EFL     (19444): ecore<19444> ecore.c:577 _ecore_magic_fail()   Input handle has already been freed!
10-26 13:14:02.705+0200 E/EFL     (19444): ecore<19444> ecore.c:586 _ecore_magic_fail() *** NAUGHTY PROGRAMMER!!!
10-26 13:14:02.705+0200 E/EFL     (19444): *** SPANK SPANK SPANK!!!
10-26 13:14:02.705+0200 E/EFL     (19444): *** Now go fix your code. Tut tut tut!
10-26 13:14:02.705+0200 I/SCONTEXT-LIB(19444): scontext.c: remove_changed_cb(145) > UnSet Changed CB: 45
10-26 13:14:02.735+0200 W/WATCH_CORE(  806): appcore-watch.c: __signal_lcd_status_handler(1157) > signal_lcd_status_signal: LCDOn
10-26 13:14:02.770+0200 I/WATCH_CORE(  806): appcore-watch.c: __signal_lcd_status_handler(1176) > Call the time_tick_cb
10-26 13:14:02.740+0200 W/STARTER (  732): clock-mgr.c: _on_lcd_signal_receive_cb(1626) > [_on_lcd_signal_receive_cb:1626] _on_lcd_signal_receive_cb, 1626, Pre LCD on by [uncharge] after screen off time [780]ms
10-26 13:14:02.770+0200 I/CAPI_WATCH_APPLICATION(  806): watch_app_main.c: _watch_core_time_tick(306) > _watch_core_time_tick
10-26 13:14:02.770+0200 W/STARTER (  732): clock-mgr.c: _pre_lcd_on(1346) > [_pre_lcd_on:1346] Will LCD ON as reserved app[(null)] alpm mode[0] charger[0]
10-26 13:14:02.775+0200 E/ALARM_MANAGER(  494): alarm-manager.c: __is_cached_cookie(228) > Find cached cookie for [732].
10-26 13:14:02.775+0200 E/ALARM_MANAGER(  494): alarm-manager.c: __alarm_remove_from_list(562) > [alarm-server]:Remove alarm id(1527177353)
10-26 13:14:02.775+0200 E/ALARM_MANAGER(  494): alarm-manager.c: __rtc_set(323) > [alarm-server]ALARM_CLEAR ioctl is successfully done.
10-26 13:14:02.775+0200 E/ALARM_MANAGER(  494): alarm-manager.c: __rtc_set(330) > Setted RTC Alarm date/time is 26-10-2017, 11:16:01 (UTC).
10-26 13:14:02.775+0200 E/ALARM_MANAGER(  494): alarm-manager.c: __rtc_set(345) > [alarm-server]RTC ALARM_SET ioctl is successfully done.
10-26 13:14:02.750+0200 W/W_INDICATOR(  735): windicator_battery.c: windicator_battery_icon_update(305) > [windicator_battery_icon_update:305] 78%
10-26 13:14:02.775+0200 E/ALARM_MANAGER(  494): alarm-manager.c: alarm_manager_alarm_delete(2426) > alarm_id[1527177353] is removed.
10-26 13:14:02.780+0200 E/EFL     (  735): <735> elm_main.c:1180 elm_object_part_text_set() safety check failed: obj == NULL
10-26 13:14:02.780+0200 W/W_INDICATOR(  735): windicator_battery.c: windicator_battery_icon_update(315) > [windicator_battery_icon_update:315] battery_level: 78, isCharging: 0
10-26 13:14:02.785+0200 W/W_INDICATOR(  735): windicator_battery.c: windicator_battery_icon_update(342) > [windicator_battery_icon_update:342] [SIGNAL] battery file : change_level_80
10-26 13:14:02.785+0200 E/W_INDICATOR(  735): windicator_moment_view.c: wnidicator_moment_view_battery_image_update(128) > [wnidicator_moment_view_battery_image_update:128] Debugging mode!, Clicked!!
10-26 13:14:02.785+0200 W/W_INDICATOR(  735): windicator_battery.c: _battery_charging_changed_cb(117) > [_battery_charging_changed_cb:117] Hide Moment View (unconnected)
10-26 13:14:02.785+0200 E/W_INDICATOR(  735): windicator_moment_view.c: windicator_moment_view_hide(1534) > [windicator_moment_view_hide:1534] Hide Moment View : dynamic_layout((nil)),Type(-1)
10-26 13:14:02.785+0200 E/W_INDICATOR(  735): windicator_connection.c: windi_connection_pause(1642) > [windi_connection_pause:1642] There is no handle
10-26 13:14:02.785+0200 W/W_INDICATOR(  735): windicator_battery.c: _battery_charger_status_changed_cb(164) > [_battery_charger_status_changed_cb:164] Hide Moment View (unconnected)
10-26 13:14:02.785+0200 E/W_INDICATOR(  735): windicator_moment_view.c: windicator_moment_view_hide(1534) > [windicator_moment_view_hide:1534] Hide Moment View : dynamic_layout((nil)),Type(-1)
10-26 13:14:02.785+0200 E/W_INDICATOR(  735): windicator_connection.c: windi_connection_pause(1642) > [windi_connection_pause:1642] There is no handle
10-26 13:14:02.790+0200 E/CAPI_APPFW_APPLICATION_PREFERENCE( 1085): preference.c: _preference_check_retry_err(507) > key(test_healthy_pace), check retry err: -21/(2/No such file or directory).
10-26 13:14:02.790+0200 E/CAPI_APPFW_APPLICATION_PREFERENCE( 1085): preference.c: _preference_get_key(1101) > _preference_get_key(test_healthy_pace) step(-17825744) failed(2 / No such file or directory)
10-26 13:14:02.790+0200 E/CAPI_APPFW_APPLICATION_PREFERENCE( 1085): preference.c: preference_get_boolean(1173) > preference_get_boolean(1085) : test_healthy_pace error
10-26 13:14:02.830+0200 W/W_HOME  (  769): event_manager.c: _ecore_x_message_cb(414) > state: 1 -> 0
10-26 13:14:02.830+0200 W/W_HOME  (  769): event_manager.c: _state_control(194) > control:4, app_state:2 win_state:0(0) pm_state:0 home_visible:1 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 1, apptray visibility : 0, apptray edit visibility : 0
10-26 13:14:02.830+0200 W/W_HOME  (  769): event_manager.c: _state_control(194) > control:2, app_state:2 win_state:0(0) pm_state:0 home_visible:1 clock_visible:1 tutorial_state:0 editing : 0, home_clocklist:0, addviewer:0 scrolling : 0, powersaving : 0, apptray state : 1, apptray visibility : 0, apptray edit visibility : 0
...
10-26 13:14:09.685+0200 W/CRASH_MANAGER(20356): worker.c: worker_job(1205) > 1120369646174150901644
