...
r0   = 0x00000000, r1   = 0x400127c0
r2   = 0x0000000d, r3   = 0x0000000d
r4   = 0x40001d81, r5   = 0x405687fc
r6   = 0x00000000, r7   = 0xbe855d38
r8   = 0x00000041, r9   = 0x408e3824
r10  = 0x42fbce00, fp   = 0x00000000
ip   = 0x40568a54, sp   = 0xbe855cf8
lr   = 0x405556fc, pc   = 0x40001dbe
cpsr = 0x60000030
...
Threads: 7
PID = 16443 TID = 16443
16443 16446 16447 16457 16458 16459 16460 
...
4003a000 4003d000 rw-p [stack:16447]
...
4368a000 43e89000 rw-p [stack:16446]
441d0000 441d1000 r-xp /usr/lib/evas/modules/loaders/eet/linux-gnueabi-armv7l-1.7.99/module.so
441da000 449d9000 rw-p [stack:16457]
449da000 451d9000 rw-p [stack:16458]
451da000 459d9000 rw-p [stack:16459]
45b01000 46300000 rw-p [stack:16460]
be836000 be857000 rw-p [stack]
End of Maps Information

Callstack Information (PID:16443)
Call Stack Count: 14
 0: on_sensor_event + 0x3d (0x40001dbe) [/opt/usr/apps/org.example.dataextraction/bin/dataextraction] + 0x1dbe
 1: (0x4005982f) [/usr/lib/libcapi-system-sensor.so.0] + 0x182f
 2: (0x4054baf0) [/usr/lib/libsensor.so.1] + 0x14af0
 3: (0x40846fcf) [/usr/lib/libglib-2.0.so.0] + 0x33fcf
 4: g_main_context_dispatch + 0xbc (0x408487a9) [/usr/lib/libglib-2.0.so.0] + 0x357a9
 5: (0x4090eca7) [/usr/lib/libecore.so.1] + 0x10ca7
 6: (0x40909b4f) [/usr/lib/libecore.so.1] + 0xbb4f
 7: (0x4090a5a7) [/usr/lib/libecore.so.1] + 0xc5a7
 8: ecore_main_loop_begin + 0x30 (0x4090a879) [/usr/lib/libecore.so.1] + 0xc879
 9: appcore_efl_main + 0x20a (0x40477523) [/usr/lib/libappcore-efl.so.1] + 0x3523
10: ui_app_main + 0xb0 (0x4004e421) [/usr/lib/libcapi-appfw-application.so.0] + 0x2421
11: main + 0x10e (0x40001623) [/opt/usr/apps/org.example.dataextraction/bin/dataextraction] + 0x1623
12: __libc_start_main + 0x114 (0x402fe82c) [/lib/libc.so.6] + 0x1782c
13: (0x4000138c) [/opt/usr/apps/org.example.dataextraction/bin/dataextraction] + 0x138c
End of Call Stack
...
10-14 17:31:27.925+0200 E/wnoti-service(  838): wnoti-db-utility.c: context_wearonoff_status_cb(1753) > status changed from 2 to 2 
10-14 17:31:27.940+0200 I/APP_CORE(16479): appcore-efl.c: __do_app(472) > Legacy lifecycle: 0
10-14 17:31:27.940+0200 I/APP_CORE(16479): appcore-efl.c: __do_app(474) > [APP 16479] Initial Launching, call the resume_cb
...
10-14 17:31:32.370+0200 W/CRASH_MANAGER(16407): worker.c: worker_job(1205) > 1116443646174150799507
